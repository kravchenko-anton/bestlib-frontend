...
import { UnfoldOutputImagesInner } from 'api-client/models';
import { getTagColor } from '@/pages/book/components/getTagColor';
import { useBookCompose } from '@/pages/book/components/ebook-editor/useBookCompose';
import { TrimContentMenu } from '@/pages/book/components/ebook-editor/trim-content-menu';
									...
									<div className=' flex w-full  justify-between p-2'>
										...
										<div className='flex items-center gap-5'>
											<HardDriveUpload
												...
												, pointerEvents: value.isUploaded ? 'none' : 'auto'
												}}
												onClick={async () => {
